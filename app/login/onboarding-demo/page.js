    ...
    <>
      ...
      <div className="flex items-center justify-center min-h-screen bg-white lg:bg-gradient-to-r from-[#8711C180] to-[#2472FCCC]">
        <div className="bg-white lg:rounded-3xl lg:shadow-lg w-full max-w-3xl p-4 mx-4 lg:mx-0 lg:px-8 lg:py-6">
          <h2 className="text-[16px] md:text-2xl font-medium text-center mb-2">
            Let's get started with a quick demo
          </h2>
          <p className="text-center text-[12px] lg:text-[16px] leading-6 font-normal text-gray-600 mb-4">
          ...
          <div className="text-center mb-4">
            ...
            <Link href="/login/create-chatbot-form" passHref>
                ...
                <button className="lg:bg-[#2472FC] hover:text-white text-[16px] font-medium flex w-full lg:w-auto border border-[#2472FC] items-center gap-2 mx-auto text-blue-500 lg:text-white px-4 py-2 rounded-xl lg:rounded-lg justify-center hover:bg-blue-700">
                  Skip{" "}
                  <svg
